...
export default function Login() {
    ...
    const handleOAuth = async (provider) => {
        try {
            ...
            if (authError) {
                setError(authError.message || "Failed to initialize login with " + provider);
            }
        } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (data?.accessToken) {
                // Store token explicitly if you need it for existing ProtectedRoute
            ...
            <div className="bg-white/90 backdrop-blur-md p-8 rounded-2xl shadow-2xl w-full max-w-md">
                ...
                <div className="flex gap-4 mt-6">
                    <button
                        ...
                        className="flex-1 flex items-center justify-center gap-2 py-3 px-4 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors shadow-sm font-medium text-gray-700 active:scale-[0.98]"
                    >
                    ...
                    <button
                        ...
                        className="flex-1 flex items-center justify-center gap-2 py-3 px-4 bg-gray-900 border border-gray-900 text-white rounded-xl hover:bg-gray-800 transition-colors shadow-sm font-medium active:scale-[0.98]"
                    >
